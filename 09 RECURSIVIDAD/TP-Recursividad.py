...
# 1) Factorial recursivo y mostrar del 1 al numero ingresado
...
pos = int(input("Ingrese posicion para serie Fibonacci "))
for i in range(pos):
...
texto = input("Ingrese palabra para verificar el palindromo ")
...
numero = int(input("Ingrese numero para sumar digitos "))
...
nivel = int(input("Ingrese cantidad de bloques nivel mas bajo "))
...
dig = int(input("Ingrese digito a buscar "))
